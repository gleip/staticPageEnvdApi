<?php /* Smarty version 3.1.27, created on 2017-01-19 18:34:12
         compiled from "/var/www/staticPageEnvdApi/manager/templates/default/header.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:182198853588106a4109310_12845534%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48ec19cf8fb31245545ef6e3cfc2ab79ef9e3faa' => 
    array (
      0 => '/var/www/staticPageEnvdApi/manager/templates/default/header.tpl',
      1 => 1483436692,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '182198853588106a4109310_12845534',
  'variables' => 
  array (
    '_config' => 0,
    '_pagetitle' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_588106a4135588_50918612',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_588106a4135588_50918612')) {
function content_588106a4135588_50918612 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '182198853588106a4109310_12845534';
?>
<!DOCTYPE html>
...
echo $_smarty_tpl->tpl_vars['_pagetitle']->value;?>
 | <?php }
echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_config']->value['site_name']), ENT_QUOTES, 'ISO-8859-1', true);?>
</title>
...
"><?php echo $_smarty_tpl->tpl_vars['_lang']->value['dashboard'];?>
                ...
                <li id="modx-site-info">
                    <div id="site_name" class="info-item site_name" title="<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_config']->value['site_name']), ENT_QUOTES, 'ISO-8859-1', true);?>
"><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['_config']->value['site_name']), ENT_QUOTES, 'ISO-8859-1', true);?>
</div>
